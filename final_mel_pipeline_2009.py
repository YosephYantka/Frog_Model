...
audacity_labels = '/home/nottom/Documents/LinuxProject/training_data_2009/1318_20170515_231921.txt' #ALTER
chunk_file_raw = '1318__0__20170515_231921.wav' #ALTER
chunk_folder = '/home/nottom/Documents/LinuxProject/training_data_2009/chunks'
text_files = '/home/nottom/Documents/LinuxProject/training_data_2009/text'
...
os.remove('/home/nottom/Documents/LinuxProject/training_data_2009/chunks/' + chunk_file_raw)
...
for chunk in annotation:
    ...
    with open('/home/nottom/Documents/LinuxProject/training_data_2009/text/' + name + '.txt', 'x') as f:
...
def save_spectrogram(specgram, title=None, ylabel="freq_bin"):
    ...
    plt.imsave("/home/nottom/Documents/LinuxProject/training_data_2009/images/" + str(title) + '.png', spec)
...
for file in os.listdir(text_files):
    ...
    destination = '/home/nottom/Documents/LinuxProject/training_data_2009/specgrams/notata/' + filename + '_1_.png'
    if content == '0, 1, 0, 0':
